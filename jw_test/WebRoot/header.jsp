...
<div id="navbar" class="navbar navbar-default">
	...
	<div class="navbar-container" id="navbar-container">
		<button type="button" class="navbar-toggle menu-toggler pull-left"
			id="menu-toggler">
			<span class="sr-only">Toggle侧边栏</span> <span class="icon-bar"></span>
			...
			<ul class="nav ace-nav">
				<li class="grey"><a data-toggle="dropdown"
					...
					<ul
						...
						<li><a href="#">
								<div class="clearfix">
									<span class="pull-left">修复漏洞</span> <span class="pull-right">90%</span>
								</div>
				...
				<li class="purple"><a data-toggle="dropdown"
					...
					<ul
						...
						<li class="dropdown-header"><i
							class="ace-icon fa fa-exclamation-triangle"></i> 8个通知</li>
						...
						<li><a href="#"> <i
								class="btn btn-xs btn-primary fa fa-user"></i> Bob刚刚以编辑身份注册...
						</a></li>
